...
var createUser = function () {
    ...
    db_Cleverbuys_db = require('../db/Cleverbuys_db_schema.js');
    db_Cleverbuys_db.User.count().exec(function (err, count) {
        if (count == 0) {
            var admin = new db_Cleverbuys_db.User({
                username: 'admin',
