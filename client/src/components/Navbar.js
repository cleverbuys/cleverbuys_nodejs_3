    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">Cleverbuys</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/brandses">
            <ListItem button key="brands">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="brands" />
            </ListItem>
          </Link>{" "}            
           <Link to="/dealerbrandses">
            <ListItem button key="dealerBrands">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="dealerBrands" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
